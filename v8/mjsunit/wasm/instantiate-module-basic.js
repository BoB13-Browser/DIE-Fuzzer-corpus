...
let buffer = (() => {
  ...
  builder.addFunction("main", kSig_i).addBody([kExprI8Const, kReturnValue]).exportFunc();
...
function CheckInstance(instance) {
  ...
  assertEquals("object", typeof instance); // Check the memory is an ArrayBuffer.
  ...
  assertEquals(65536, instance.exports.memory.byteLength); // Check the properties of the main function.
...
CheckInstance(Wasm.instantiateModule(buffer)); // Official API
