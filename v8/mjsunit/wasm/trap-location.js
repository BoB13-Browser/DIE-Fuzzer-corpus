...
load("test/mjsunit/wasm/wasm-module-builder.js"); // Collect the Callsite objects instead of just a string:
...
var sig_index = builder.addType(kSig_i_v); // Build a function to resemble this code:
//   if (idx < 2) {
//     return load(-2 / idx);
//   } else if (idx == 2) {
//     unreachable;
...
builder.addFunction("main", kSig_i_i).addBody([// offset 1
kExprBlock, kExprGetLocal, 0, kExprI32Const, 2, kExprI32LtU, kExprIf, // offset 8
kExprI32Const, 0x7e
/* -2 */
, kExprGetLocal, 0, kExprI32DivU, // offset 13
kExprI32LoadMem, 0, 0, kExprBr, 1, 1, kExprEnd, // offset 20
kExprGetLocal, 0, kExprI32Const, 2, kExprI32Eq, kExprIf, kExprUnreachable, kExprEnd, // offset 28
kExprGetLocal, 0, kExprCallIndirect, kArity0, sig_index, kExprEnd]).exportAs("main");
