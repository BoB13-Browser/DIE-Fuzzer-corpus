...
var kDeclNoLocals = 0; // Section declaration constants
...
var section_names = ["memory", "type", "old_function", "global", "data", "table", "end", "start", "import", "export", "function", "code", "name"]; // Function declaration flags

var kDeclFunctionName = 0x01;
var kDeclFunctionImport = 0x02;
var kDeclFunctionLocals = 0x04;
var kDeclFunctionExport = 0x08; // Local types

var kAstStmt = 0;
var kAstI32 = 1;
var kAstI64 = 2;
var kAstF32 = 3;
var kAstF64 = 4; // Useful signatures
...
var kTrapMsgs = ["unreachable", "memory access out of bounds", "divide by zero", "divide result unrepresentable", "remainder by zero", "integer result unrepresentable", "invalid function", "function signature mismatch"];
...
function assertTraps(trap, code) {
  ...
  try {
    ...
    assertEquals(kTrapMsgs[trap], e.message); // Success.
