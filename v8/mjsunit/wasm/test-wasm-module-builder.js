...
(function BasicTest() {
  ...
  module.addFunction("foo", kSig_i).addBody([kExprI8Const, 11]).exportAs("blarg");
...
(function ImportTest() {
  ...
  module.addFunction("foo", kSig_v_v).addBody([kExprI8Const, 13, kExprCallImport, kArity1, index]).exportAs("main");
  var buffer = module.toBuffer(debug);
  var instance = Wasm.instantiateModule(buffer, {
    print: print
  });
...
(function LocalsTest() {
  var module = new WasmModuleBuilder();
  module.addFunction(undefined, kSig_i_i).addLocals({
    i32_count: 1
  }).addBody([kExprGetLocal, 0, kExprSetLocal, 1]).exportAs("main");
  var buffer = module.toBuffer(debug);
  var instance = Wasm.instantiateModule(buffer);
...
(function LocalsTest2() {
  ...
  for (p of types) {
    var module = new WasmModuleBuilder();
    module.addFunction(undefined, makeSig_r_x(p.type, p.type)).addLocals(p.locals).addBody([kExprGetLocal, 0, kExprSetLocal, 1]).exportAs("main");
    var buffer = module.toBuffer(debug);
    var instance = Wasm.instantiateModule(buffer);
    assertEquals(19, instance.exports.main(19));
    assertEquals(27777, instance.exports.main(27777));
...
(function CallTest() {
  var module = new WasmModuleBuilder();
  module.addFunction("add", kSig_i_ii).addBody([kExprGetLocal, 0, kExprGetLocal, 1, kExprI32Add]);
  module.addFunction("main", kSig_i_ii).addBody([kExprGetLocal, 0, kExprGetLocal, 1, kExprCallFunction, kArity2, 0]).exportAs("main");
...
(function IndirectCallTest() {
  var module = new WasmModuleBuilder();
  module.addFunction("add", kSig_i_ii).addBody([kExprGetLocal, 0, kExprGetLocal, 1, kExprI32Add]);
  module.addFunction("main", kSig_i_iii).addBody([kExprGetLocal, 0, kExprGetLocal, 1, kExprGetLocal, 2, kExprCallIndirect, kArity2, 0]).exportAs("main");
...
(function DataSegmentTest() {
  ...
  module.addFunction("load", kSig_i_i).addBody([kExprGetLocal, 0, kExprI32LoadMem, 0, 0]).exportAs("load");
...
(function BasicTestWithUint8Array() {
  var module = new WasmModuleBuilder();
  module.addMemory(1, 2, false);
  module.addFunction("foo", kSig_i).addBody([kExprI8Const, 17]).exportAs("blarg");
  var buffer = module.toBuffer(debug);
...
(function ImportTestTwoLevel() {
  ...
  module.addFunction("foo", kSig_v_v).addBody([kExprI8Const, 19, kExprCallImport, kArity1, index]).exportAs("main");
  var buffer = module.toBuffer(debug);
  var instance = Wasm.instantiateModule(buffer, {
    mod: {
      print: print
