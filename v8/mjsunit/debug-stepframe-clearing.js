...
var o = {};
Object.defineProperty(o, "slappy", {
  get: get
});
Debug = debug.Debug;
var break_count = 0;
...
function listener(event, exec_state, event_data, data) {
  ...
  try {
    ...
    if (break_count >= 0 && break_count < 2) {
      ...
      assertEquals(2, match_value); // Apparently we can still stop in the accessor even though we cleared
...
for (var j = 1; j < 3; j++) {
  break_count = 0;
  Debug.setListener(listener); // Breakpoints are added here rather than in the listener because their
