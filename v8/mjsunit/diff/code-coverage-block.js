...
TestCoverage("call locally allocated function", `let f = () => 1; f();`, [{
  "start": 0,
  "end": 21,
  "count": 1
}, {
...
TestCoverage("if statement (early return)", `
!function() {                             // 0000
  if (true) {                             // 0050
    nop();                                // 0100
    return;                               // 0150
...
TestCoverage("if statement (no semi-colon)", `
!function() {                             // 0000
  if (true) nop()                         // 0050
...
TestCoverage("for statements pt. 2", `
function g() {}                           // 0000
!function() {                             // 0050
  let j = 0;                              // 0100
...
TestCoverage("for statements (no semicolon)", `
function g() {}                           // 0000
!function() {                             // 0050
...
TestCoverage("for statement (early return)", `
!function() {                             // 0000
...
TestCoverage("for-of and for-in statements", `
!function() {                             // 0000
  var i;                                  // 0050
...
TestCoverage("for-await-of statements", `
!async function() {                       // 0000
...
TestCoverage("while and do-while statements", `
function g() {}                           // 0000
!function() {                             // 0050
  var i;                                  // 0100
...
TestCoverage("while statement (early return)", `
!function() {                             // 0000
  let i = 0;                              // 0050
  while (i < 10) {                        // 0100
    i++;                                  // 0150
...
TestCoverage("do-while statement (early return)", `
!function() {                             // 0000
  let i = 0;                              // 0050
  do {                                    // 0100
    i++;                                  // 0150
...
TestCoverage("return statements", `
...
TestCoverage("try/catch/finally statements", `
!function() {                             // 0000
...
TestCoverage("early return in blocks", `
!function() {                             // 0000
  try { throw 42; } catch (e) { return; } // 0050
  nop();                                  // 0100
}();                                      // 0150
...
TestCoverage("switch statements", `
!function() {                             // 0000
  var x = 42;                             // 0050
  switch (x) {                            // 0100
...
TestCoverage("labeled break statements", `
!function() {                             // 0000
  var x = 42;                             // 0050
  l0: switch (x) {                        // 0100
  case 41: return;                        // 0150
...
TestCoverage("labeled continue statements", `
!function() {                             // 0000
...
TestCoverage("conditional expressions", `
var TRUE = true;                          // 0000
...
TestCoverage("yield expressions", `
...
TestCoverage("yield expressions (.return and .throw)", `
...
TestCoverage("await expressions", `
...
TestCoverage("LogicalOrExpression assignment", `
...
TestCoverage("LogicalOrExpression IsTest()", `
true || false                             // 0000
const a = 99                              // 0050
a || 50                                   // 0100
const b = false                           // 0150
...
TestCoverage("LogicalAndExpression assignment", `
...
TestCoverage("LogicalAndExpression IsTest()", `
false && true                             // 0000
const a = 0                               // 0050
a && 50                                   // 0100
const b = true                            // 0150
...
TestCoverage("NaryLogicalOr assignment", `
const a = true                            // 0000
const b = false                           // 0050
...
TestCoverage("NaryLogicalOr IsTest()", `
const a = true                            // 0000
const b = false                           // 0050
false || false || 99                      // 0100
false || true || 99                       // 0150
...
TestCoverage("NaryLogicalAnd assignment", `
const a = true                            // 0000
const b = false                           // 0050
const c = false && false && 99            // 0100
const d = false && true && 99             // 0150
...
TestCoverage("NaryLogicalAnd IsTest()", `
const a = true                            // 0000
const b = false                           // 0050
false && false && 99                      // 0100
false && true && 99                       // 0150
...
TestCoverage("logical expressions + conditional expressions", `
const a = true                            // 0000
const b = 99                              // 0050
const c = false                           // 0100
const d = ''                              // 0150
...
TestCoverage("https://crbug.com/827530", `
Util = {};                                // 0000
...
TestCoverage("https://crbug.com/v8/8237", `
!function() {                             // 0000
  if (true)                               // 0050
...
TestCoverage("terminal break statement", `
while (true) {                            // 0000
  const b = false                         // 0050
  break                                   // 0100
}                                         // 0150
...
TestCoverage("terminal return statement", `
function a () {                           // 0000
  const b = false                         // 0050
  return 1                                // 0100
}                                         // 0150
...
TestCoverage("terminal if statements", `
