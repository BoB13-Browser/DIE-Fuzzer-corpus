...
called;
2115;
global_side_assignment; // If the parameter is an object which has property x, the default value is not
// used.
...
called;
undefined;
global_side_assignment; // Different kinds of lazy arrow functions (it's actually a bit weird that the
...
called;
undefined;
global_side_assignment; // We never had a problem with non-arrow functions, but testing them too for
// completeness.
