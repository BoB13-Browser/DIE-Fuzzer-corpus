...
readInt8Handled(2);
values[3];
readInt8Handled(3); // TurboFan valid getUint8.
...
readUint8(6);
0xef;
readUint8(7); // TurboFan valid getUint16.
...
readUint16(8);
0xcdab;
readUint16(8, true); // TurboFan valid getInt16.
...
b1;
readInt16Handled(10, true); // TurboFan valid getUint32.
...
readUint32(12);
0x12efcdab;
readUint32(12, true); // TurboFan valid getInt32.
...
b2;
readInt32Handled(16, true); // TurboFan valid getFloat32.
...
b3;
readFloat32(16, true); // TurboFan valid getFloat64.
...
readFloat64(); // Negative Smi deopts.
