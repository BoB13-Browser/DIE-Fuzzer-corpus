...
assertThrows(function () {
  f(3);
}, ReferenceError); // Ensure that hole checks are done even in subordinate scopes
...
}, ReferenceError); // Ensure that inner functions and eval don't skip hole checks
...
assertThrows(function () {
  g(5);
}, ReferenceError); // Ensure the same in strict mode, with different eval and function semantics
