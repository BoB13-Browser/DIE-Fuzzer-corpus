...
assertTrue(new Date('+275760-10-13') == 'Invalid Date'); // The following cases used to throw "illegal access"

assertTrue(new Date('275760-09-24') == 'Invalid Date');
assertTrue(new Date('275760-10-13') == 'Invalid Date');
assertTrue(new Date('+275760-10-13 ') == 'Invalid Date'); // However, dates within the range or valid
