...
if (this.Intl) {
  ...
  assertEquals(df1.resolvedOptions().timeZone, df2.resolvedOptions().timeZone); // Normalizes Ulan_Bator to Ulaanbaatar. Unlike Kat(h)mandu, ICU got this
  ...
  assertEquals('Asia/Ulaanbaatar', df.resolvedOptions().timeZone); // Throws for unsupported time zones.
