...
(function TestIdentityEscapes() {
  ...
  assertTrue(r1.test("usecond"));
  var r2 = /first\u/;
  assertTrue(r2.test("firstu")); // This used to return true (which was a bug).
  ...
  assertTrue(r4.test("firstu123second"));
  assertFalse(r4.test("first\\u123second")); // \X where X is not a legal escape character is treated as identity escape
  // too.
