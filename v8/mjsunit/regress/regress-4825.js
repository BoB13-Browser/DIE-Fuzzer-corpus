...
(function testSlowSloppyArgumentsElements() {
  ...
  assertEquals(["0", "1", "2", "3999", "4000", "5999", "6000", "10000"], Object.keys(slowSloppyArguments(1, 2, 3)));
  assertEquals(["0", "1", "2", "3999", "4000", "5999", "6000", "10000"], enumerate(slowSloppyArguments(1, 2, 3)));
})();
...
(function testSlowSloppyArgumentsElementsNotEnumerable() {
  ...
  assertEquals(["0", "1", "2", "3999", "4000", "5999", "6000"], Object.keys(slowSloppyArguments(1, 2, 3)));
  assertEquals(["0", "1", "2", "3999", "4000", "5999", "6000"], enumerate(slowSloppyArguments(1, 2, 3)));
})();
...
(function testFastSloppyArgumentsElements() {
  ...
  assertEquals(["0", "1", "2", "3", "5", "7"], Object.keys(fastSloppyArguments(1, 2, 3)));
  assertEquals(["0", "1", "2", "3", "5", "7"], enumerate(fastSloppyArguments(1, 2, 3)));
...
(function testFastSloppyArgumentsElementsNotEnumerable() {
  ...
  assertEquals(["0", "1", "2", "3", "7"], Object.keys(fastSloppyArguments(1, 2, 3)));
  assertEquals(["0", "1", "2", "3", "7"], enumerate(fastSloppyArguments(1, 2, 3)));
