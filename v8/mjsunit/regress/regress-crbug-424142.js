...
var actual = Debug.setBreakPointByScriptIdAndPosition(script.id, line_start).actual_position; // Make sure the actual break position is within the line where we set
// the break point.
