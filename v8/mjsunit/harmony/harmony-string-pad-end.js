...
(function TestMeta() {
  ...
  assertEquals(Object.getPrototypeOf(Function), Object.getPrototypeOf(String.prototype.padEnd));
...
(function TestFillerToString() {
  ...
  assertEquals(".XXXXXXXXX", ".".padEnd(10, {
    toString() {
      return "X";
    }

  }));
  assertEquals(".111111111", ".".padEnd(10, {
    toString: undefined,
