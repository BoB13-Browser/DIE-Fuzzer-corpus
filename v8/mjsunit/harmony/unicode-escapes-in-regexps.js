...
(function TestTooBigHexEscape() {
  ...
  assertThrows("new RegExp('\\\\u{110000}', 'u')", SyntaxError); // Without the u flag, they're of course fine ({x} is the count).
...
assertFalse(/\u{12345}/u.test("\udf45")); // Multi-character atom.
...
assertFalse(/\u{12345}\u{23456}/u.test("b\udf45\u{23456}c")); // Disjunction.

assertTrue(new RegExp("\u{12345}(?:\u{23456})", "u").test("a\u{12345}\u{23456}b"));
assertTrue(/\u{12345}(?:\u{23456})/u.test("b\u{12345}\u{23456}c"));
assertFalse(new RegExp("\u{12345}(?:\u{23456})", "u").test("a\udf45\u{23456}b"));
assertFalse(/\u{12345}(?:\u{23456})/u.test("b\udf45\u{23456}c")); // Alternative.
...
assertFalse(/\u{12345}|\u{23456}/u.test("b\udf45\ud808c")); // Capture.
...
assertFalse(/(\u{12345}|\u{23456}).\1/u.test("\u{12345}b\u{23456}")); // Quantifier.
...
assertFalse(/\u{12345}{3}/u.test("\u{12345}\udf45\udf45")); // Literal surrogates.
...
assertEquals(["\u{10003}\u{50001}"], new RegExp("[\\ud800\\udc03-\\ud900\\udc01\]+", "u").exec("\u{10003}\u{50001}"));
assertEquals(["\u{10003}\u{50001}"], new RegExp("[\ud800\udc03-\u{50001}\]+", "u").exec("\u{10003}\u{50001}")); // Unicode escape sequences to represent a non-BMP character cannot have
