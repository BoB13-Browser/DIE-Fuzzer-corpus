...
assertEquals(classesWithSpecies.length, new Set(classesWithSpecies.map(constructor => Object.getOwnPropertyDescriptor(constructor, Symbol.species).get)).size);

for (let constructor of classesWithoutSpecies) assertEquals(undefined, constructor[Symbol.species]);