...
(function TestMeta() {
  ...
  assertEquals(Object.getPrototypeOf(Function), Object.getPrototypeOf(String.prototype.padStart));
...
(function TestFillerToString() {
  ...
  assertEquals("XXXXXXXXX.", ".".padStart(10, {
    toString() {
      return "X";
    }

  }));
  assertEquals("111111111.", ".".padStart(10, {
    toString: undefined,
