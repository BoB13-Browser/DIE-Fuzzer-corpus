...
assertEquals(["debugger;", "results.push(BestEditor());", "  return 'Emacs';", "}", "results.push(BestEditor());", "results.push(BestEditor());", "  return 'Emacs';", "  return 'Eclipse';", "}", "results.push(BestEditor());", "results.push(BestEditor());", "  return 'Eclipse';", "  return 'Vim';", "}", "results.push(BestEditor());", "Debug.setListener(null);"], log);