...
for (var constructor of typedArrayConstructors) {
  ...
  assertArrayEquals(new constructor([0, 0, 0, 0, 0]).fill(8, 0, 4), [8, 8, 8, 8, 0]); // Test exceptions
  ...
  assertThrows('constructor.prototype.fill.call([])', TypeError); // Shadowing length doesn't affect fill, unlike Array.prototype.fill
