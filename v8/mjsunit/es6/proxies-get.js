...
(function testFailingInvariant() {
  ...
  assertEquals("value", proxy.key3); // Define a non-configurable, non-writeable property on the target for
  ...
  assertEquals("value", proxy.key2);
  assertEquals("value", proxy.key3); // Define a non-configurable getter on the target for which the handler
  ...
  assertEquals("value", proxy.key2);
  assertEquals("value", proxy.key3); // Define a non-configurable setter without a corresponding getter on the
  ...
  assertThrows(function () {
    proxy.key3;
  }, TypeError); // Define a non-configurable setter without a corresponding getter on the
...
(function testGetInternalIterators() {
  ...
  assertEquals(["[[Get]](iterator, Symbol(Symbol.iterator))", "[[Get]](iterator, next)"], log);
})();