...
assertEquals("[object Object]", result); // ArrayToLocaleString

var o = {
  length: Number.MIN_VALUE
};
var result = Array.prototype.toLocaleString.call(o);
assertEquals("", result); // ArrayJoin

var o = {
  length: Number.MIN_VALUE
};
var result = Array.prototype.join.call(o);
assertEquals(0, result.length); // ArrayPush
...
assertThrows(() => Array.prototype.push.call(o, 1), TypeError); // ArrayPop
...
Array.prototype.pop.call(o);
assertEquals(o.length, Number.MAX_SAFE_INTEGER - 1); // ArrayReverse
...
assertEquals(Number.MIN_VALUE, o.length); // ArrayShift
...
assertEquals(0, o.length); // ArrayUnshift
...
Array.prototype.unshift.call(o, 'foo');
assertEquals('foo', o[0]);
assertEquals(1, o.length); // ArraySplice
...
Array.prototype.splice.call(o, -1);
assertEquals(Number.MAX_SAFE_INTEGER - 1, o.length); // ArraySlice
...
assertEquals(0, result.length); // ArrayIndexOf
...
assertEquals(Number.MAX_SAFE_INTEGER - 1, result); // ArrayLastIndexOf
...
assertEquals(Number.MAX_SAFE_INTEGER - 1, result); // ArrayFilter
...
assertEquals(Number.MIN_VALUE, o.length); // ArrayForEach

var o = {
  length: Number.MIN_VALUE
};
Array.prototype.forEach.call(o, func);
assertEquals(Number.MIN_VALUE, o.length); // ArraySome

var o = {
  length: Number.MIN_VALUE
};
Array.prototype.some.call(o, func);
assertEquals(Number.MIN_VALUE, o.length); // ArrayEvery

var o = {
  length: Number.MIN_VALUE
};
Array.prototype.every.call(o, func);
assertEquals(Number.MIN_VALUE, o.length); // ArrayMap

var o = {
  length: Number.MIN_VALUE
};
Array.prototype.map.call(o, func);
assertEquals(Number.MIN_VALUE, o.length); // ArrayReduce

var o = {
  length: Number.MIN_VALUE
};
Array.prototype.reduce.call(o, func, 0);
assertEquals(Number.MIN_VALUE, o.length); // ArrayReduceRight

var o = {
  length: Number.MIN_VALUE
};
Array.prototype.reduceRight.call(o, func, 0);
assertEquals(Number.MIN_VALUE, o.length); // ArrayFill
