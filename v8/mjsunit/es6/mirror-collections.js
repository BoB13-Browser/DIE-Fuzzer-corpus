...
function testMapMirror(mirror) {
  ...
  assertTrue(mirror.isMap()); // Parse JSON representation and check.
...
function testSetMirror(mirror) {
  ...
  assertTrue(mirror.isSet()); // Parse JSON representation and check.
...
var o1 = new Object();
var o2 = new Object();
var o3 = new Object(); // Test the mirror object for Maps
...
assertEquals(2, mapMirror.entries(2).length); // Test the mirror object for Sets
