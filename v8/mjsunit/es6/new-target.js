...
(function TestOtherScopes() {
  function f1() {
    return eval("'use strict'; new.target");
  }

  assertSame(f1, new f1());

  function f2() {
    with ({}) return new.target;
  }
...
(function TestInlining() {
  ...
  new function () {
    assertEquals(undefined, get_new_target());
  }();
  new function () {
    assertEquals(get_new_target, new get_new_target());
  }();
...
(function TestEarlyErrors() {
  assertThrows(function () {
    Function("new.target = 42");
  }, ReferenceError);
  assertThrows(function () {
    Function("var foo = 1; new.target = foo = 42");
  }, ReferenceError);
  assertThrows(function () {
    Function("var foo = 1; foo = new.target = 42");
  }, ReferenceError);
  assertThrows(function () {
    Function("new.target--");
  }, ReferenceError);
