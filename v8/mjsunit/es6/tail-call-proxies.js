...
(function test() {
  ...
  assertEquals(12, g1(1)); // Caller has more arguments than callee.
  ...
  assertEquals(12, g2(1, 2, 3)); // Caller has less arguments than callee.
  ...
  assertEquals(19, g3(1)); // Callee has arguments adaptor frame.
...
(function test() {
  ...
  assertEquals(12, g1()); // Caller has more arguments than callee.
  ...
  assertEquals(12, g2()); // Caller has less arguments than callee.
  ...
  assertEquals(19, g3()); // Callee has arguments adaptor frame.
