...
for (var constructor of typedArrayConstructors) {
  ...
  assertEquals("1,2,3", a1.toLocaleString()); // Non-standard "join" function is called correctly.
  ...
  assertEquals("1,2,3", a2.toLocaleString()); // Non-callable join function is ignored and Object.prototype.toString is
  // used instead.

  var a3 = new constructor([1, 2, 3]);
  a3.join = "not callable";
  assertEquals(0, a3.toString().search(/\[object .+Array\]/)); // Non-existing join function is treated same as non-callable.
  ...
  assertEquals(0, a3.toString().search(/\[object .+Array\]/)); // On a non-Array object, throws.
  ...
  assertThrows(function () {
    o1.toLocaleString();
  }, TypeError); // toString is OK if join not from here:
  ...
  assertThrows(function () {
    o1.toLocaleString();
  }, TypeError); // TODO(littledan): Use the same function for TypedArray as for
