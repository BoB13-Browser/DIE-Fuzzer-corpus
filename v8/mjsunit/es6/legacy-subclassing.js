...
Object.defineProperty(MyUint8Array.prototype, "BYTES_PER_ELEMENT", {
  value: 1
});
...
assertEquals(MyPromise, myPromise.then().constructor); // However, subarray instantiates members of the parent class
