...
(function TestProxyProto() {
  ...
  assertEquals(2, Object.getOwnPropertyDescriptor(global, sym).value); // We currently do not invoke proxy traps for symbols
...
(function TestProxyReceiver() {
  ...
  object.setY(10);
  assertEquals(10, object.y); // Change the receiver to the proxy, but the set is called on the global.
