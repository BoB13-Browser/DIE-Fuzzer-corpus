...
(function () {
  ...
  PaymentCredentialStorageStatus.validate = function (enumValue) {
    ...
    if (isExtensible || this.isKnownEnumValue(enumValue)) return validator.validationError.NONE;
  ...
  PaymentCredential_StorePaymentCredential_Params.prototype.initFields_ = function (fields) {
    for (var field in fields) {
      if (this.hasOwnProperty(field)) this[field] = fields[field];
    }
  };
  ...
  PaymentCredential_StorePaymentCredential_Params.validate = function (messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE) return err;
    var kVersionSizes = [{
      version: 0,
      numBytes: 32
    }];
    err = messageValidator.validateStructVersion(offset, kVersionSizes);
    if (err !== validator.validationError.NONE) return err; // validate PaymentCredential_StorePaymentCredential_Params.credentialId

    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 1, codec.Uint8, false, [0], 0);
    if (err !== validator.validationError.NONE) return err; // validate PaymentCredential_StorePaymentCredential_Params.rpId

    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, false);
    if (err !== validator.validationError.NONE) return err; // validate PaymentCredential_StorePaymentCredential_Params.userId
  ...
  PaymentCredential_StorePaymentCredential_Params.decode = function (decoder) {
    ...
    val.credentialId = decoder.decodeArrayPointer(codec.Uint8);
    val.rpId = decoder.decodeStruct(codec.String);
    val.userId = decoder.decodeArrayPointer(codec.Uint8);
    return val;
  };
  ...
  PaymentCredential_StorePaymentCredential_ResponseParams.validate = function (messageValidator, offset) {
    ...
    err = messageValidator.validateStructVersion(offset, kVersionSizes);
    if (err !== validator.validationError.NONE) return err; // validate PaymentCredential_StorePaymentCredential_ResponseParams.status
  ...
  PaymentCredential_StorePaymentCredential_ResponseParams.decode = function (decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.status = decoder.decodeStruct(new codec.Enum(PaymentCredentialStorageStatus));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  function PaymentCredentialPtr(handleOrPtrInfo) {
    this.ptr = new bindings.InterfacePtrController(PaymentCredential, handleOrPtrInfo);
  }

  function PaymentCredentialAssociatedPtr(associatedInterfacePtrInfo) {
    this.ptr = new associatedBindings.AssociatedInterfacePtrController(PaymentCredential, associatedInterfacePtrInfo);
  }

  PaymentCredentialAssociatedPtr.prototype = Object.create(PaymentCredentialPtr.prototype);
  PaymentCredentialAssociatedPtr.prototype.constructor = PaymentCredentialAssociatedPtr;
  ...
  PaymentCredentialPtr.prototype.storePaymentCredential = function () {
    return PaymentCredentialProxy.prototype.storePaymentCredential.apply(this.ptr.getProxy(), arguments);
  };
  ...
  PaymentCredentialProxy.prototype.storePaymentCredential = function (credentialId, rpId, userId) {
    ...
    return new Promise(function (resolve, reject) {
      var builder = new codec.MessageV1Builder(kPaymentCredential_StorePaymentCredential_Name, codec.align(PaymentCredential_StorePaymentCredential_Params.encodedSize), codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(PaymentCredential_StorePaymentCredential_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function (message) {
        var reader = new codec.MessageReader(message);
        var responseParams = reader.decodeStruct(PaymentCredential_StorePaymentCredential_ResponseParams);
  ...
  PaymentCredentialStub.prototype.acceptWithResponder = function (message, responder) {
    var reader = new codec.MessageReader(message);
    ...
    switch (reader.messageName) {
      case kPaymentCredential_StorePaymentCredential_Name:
        ...
        this.storePaymentCredential(params.credentialId, params.rpId, params.userId).then(function (response) {
          var responseParams = new PaymentCredential_StorePaymentCredential_ResponseParams();
          responseParams.status = response.status;
          var builder = new codec.MessageV1Builder(kPaymentCredential_StorePaymentCredential_Name, codec.align(PaymentCredential_StorePaymentCredential_ResponseParams.encodedSize), codec.kMessageIsResponse, reader.requestID);
          builder.encodeStruct(PaymentCredential_StorePaymentCredential_ResponseParams, responseParams);
          var message = builder.finish();
  ...
  function validatePaymentCredentialRequest(messageValidator) {
    ...
    switch (message.getName()) {
      case kPaymentCredential_StorePaymentCredential_Name:
        if (message.expectsResponse()) paramsClass = PaymentCredential_StorePaymentCredential_Params;
        break;
    }

    if (paramsClass === null) return validator.validationError.NONE;
  ...
  function validatePaymentCredentialResponse(messageValidator) {
    ...
    switch (message.getName()) {
      case kPaymentCredential_StorePaymentCredential_Name:
        if (message.isResponse()) paramsClass = PaymentCredential_StorePaymentCredential_ResponseParams;
        break;
    }
