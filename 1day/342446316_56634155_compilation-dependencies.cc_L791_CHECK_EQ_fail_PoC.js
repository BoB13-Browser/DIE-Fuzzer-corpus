...
// CRASH INFO
// ==========
// INSTANCE TAG: 23b34a5b
// TERMSIG: 5
// STDERR:
// #
// # Fatal error in ../../src/compiler/compilation-dependencies.cc, line 791
// # Check failed: *type_.object() == owner->instance_descriptors(isolate)->GetFieldType(descriptor_) (1 vs. 0x0b42002db9b1 <Map[32](HOLEY_ELEMENTS)>).
// #
// #
// #
// #FailureMessage Object: 0x7ffcfaf08ca0
// ==== C stack trace ===============================
// 
//     ../v8/out/fuzzbuild/d8(+0x8fe472) [0x6238210af472]
//     ../v8/out/fuzzbuild/d8(+0x8fcf47) [0x6238210adf47]
//     ../v8/out/fuzzbuild/d8(+0x8efa6a) [0x6238210a0a6a]
//     ../v8/out/fuzzbuild/d8(+0x2bed6f0) [0x62382339e6f0]
//     ../v8/out/fuzzbuild/d8(+0x2bdcef4) [0x62382338def4]
//     ../v8/out/fuzzbuild/d8(+0x2c46004) [0x6238233f7004]
//     ../v8/out/fuzzbuild/d8(+0xb68a94) [0x623821319a94]
//     ../v8/out/fuzzbuild/d8(+0xb83dcb) [0x623821334dcb]
//     ../v8/out/fuzzbuild/d8(+0xc99ba8) [0x62382144aba8]
//     ../v8/out/fuzzbuild/d8(+0xe8faa4) [0x623821640aa4]
//     ../v8/out/fuzzbuild/d8(+0x1c443e4) [0x6238223f53e4]
//     ../v8/out/fuzzbuild/d8(+0x1c43d1b) [0x6238223f4d1b]
//     ../v8/out/fuzzbuild/d8(+0x3e7f6b6) [0x6238246306b6]
// STDOUT:
// 
// FUZZER ARGS: .build/x86_64-unknown-linux-gnu/debug/FuzzilliCli --profile=v8 ../v8/out/fuzzbuild/d8 --jobs=32 --engine=multi --logLevel=verbose --timeout=1200 --storagePath=../v8_fuzzing_results --resume --exportStatistics --statisticsExportInterval=5 --diagnostics --tag=23b34a5b
// TARGET ARGS: ../v8/out/fuzzbuild/d8 --expose-gc --omit-quit --allow-natives-syntax --fuzzing --jit-fuzzing --future --harmony --js-staging
// CONTRIBUTORS: 
// EXECUTION TIME: 2747ms
