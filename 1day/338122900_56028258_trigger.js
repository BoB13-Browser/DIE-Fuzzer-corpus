function f0() {
  ...
  // v8 <- EndWasmModule
  //
  const v8 = new WebAssembly.Instance(new WebAssembly.Module(new Uint8Array([0x00, 0x61, 0x73, 0x6D, 0x01, 0x00, 0x00, 0x00, 0x01, 0x04, 0x01, 0x60, 0x00, 0x00, 0x03, 0x02, 0x01, 0x00, 0x04, 0x01, 0x00, 0x05, 0x01, 0x00, 0x06, 0x01, 0x00, 0x07, 0x06, 0x01, 0x02, 0x77, 0x30, 0x00, 0x00, 0x0A, 0x04, 0x01, 0x02, 0x00, 0x0B])));
  let v11 = WebAssembly.promising(v8.exports.w0);
  v11(f0, f0);
  console.log("A"); // WasmModule Code:
  // BeginWasmModule
  ...
  const v57 = new WebAssembly.Instance(new WebAssembly.Module(new Uint8Array([0x00, 0x61, 0x73, 0x6D, 0x01, 0x00, 0x00, 0x00, 0x01, 0x0A, 0x01, 0x60, 0x05, 0x7F, 0x7C, 0x7F, 0x7C, 0x7F, 0x01, 0x7D, 0x03, 0x02, 0x01, 0x00, 0x04, 0x01, 0x00, 0x05, 0x01, 0x00, 0x06, 0x01, 0x00, 0x07, 0x06, 0x01, 0x02, 0x77, 0x30, 0x00, 0x00, 0x0A, 0x10, 0x01, 0x0E, 0x01, 0x01, 0x7D, 0x43, 0xB2, 0xEA, 0xD0, 0x40, 0x21, 0x05, 0x20, 0x05, 0x0F, 0x0B])));
  console.log("B"); // This triggers lazy compilation.
